    ...
    extend: {
      colors: {
        histown: {
          ...
          primary: '#0891b2',      // Cyan blue - main brand color
          secondary: '#e0f2fe',    // Light cyan - secondary/accent
          accent: '#0e7490',       // Dark cyan - accent color
          neutral: '#f1f5f9',      // Light grey background
