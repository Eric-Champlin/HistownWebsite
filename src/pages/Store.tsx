...
const Store: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const testimonialsTrack = document.getElementById('testimonials-track-store');
    if (testimonialsTrack) {
      ...
      const prevBtn = document.getElementById('testimonial-prev-store');
      const nextBtn = document.getElementById('testimonial-next-store');
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-12 sm:px-16 lg:px-20">
          <div className="max-w-4xl mx-auto text-center animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 ease-out mb-16">
            <div className="bg-gradient-to-br from-histown-primary/40 to-histown-accent/40 p-1.5 rounded-3xl shadow-lg">
              <div className="p-12 rounded-2xl" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fafcfe 30%, #f5fafd 60%, #f0f9ff 85%, #fafcfe 100%)' }}>
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-histown-primary to-histown-accent rounded-full flex items-center justify-center">
                  <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                  </svg>
                </div>
                <div className="flex flex-col items-center mb-6">
                  <h2 className="text-4xl md:text-5xl mb-4 text-gray-800" style={{ fontFamily: '"Rock Salt", cursive', fontWeight: 400 }}>
                    Coming Soon!
                  </h2>
        ...
        <div className="max-w-6xl mx-auto px-12 sm:px-16 lg:px-20">
          ...
          <div className="relative px-16 animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 ease-out" style={{ transitionDelay: '400ms' }}>
            ...
            <div className="overflow-hidden py-4">
              <div id="testimonials-track-store" className="flex transition-transform duration-300 ease-in-out">
              </div>
            </div>
          </div>
        </div>
