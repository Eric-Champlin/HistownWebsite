    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[50vh] min-h-[400px] sm:h-[60vh] sm:min-h-[500px] flex items-center justify-center overflow-hidden section-divider-mobile">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-black uppercase mb-3 sm:mb-4 text-white" style={{ fontWeight: 900, textShadow: '0 4px 6px rgba(0, 0, 0, 0.5), 0 2px 4px rgba(0, 0, 0, 0.3)' }}>
            DANCE CLASSES
          </h1>
