        ...
        <div className="relative max-w-5xl mx-auto px-12 sm:px-16 lg:px-20">
          <div className="bg-gradient-to-br from-histown-primary/40 to-histown-accent/40 p-2 rounded-3xl shadow-2xl animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 ease-out">
            <div className="p-8 md:p-12 rounded-2xl" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fafcfe 30%, #f5fafd 60%, #f0f9ff 85%, #fafcfe 100%)' }}>
              <h2 className="text-3xl md:text-4xl font-black uppercase mb-6 text-gray-800" style={{ fontWeight: 900 }}>
                A Week of Free Trial Classes!
              </h2>
              <div className="h-1 w-64 bg-gradient-to-r from-histown-primary via-histown-accent to-transparent rounded-full mb-8"></div>
