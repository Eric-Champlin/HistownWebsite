...
const FreeTrial: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const testimonialsTrack = document.getElementById('testimonials-track-trial');
    if (testimonialsTrack) {
      ...
      const prevBtn = document.getElementById('testimonial-prev-trial');
      const nextBtn = document.getElementById('testimonial-next-trial');
            ...
            <div className="p-8 md:p-12 rounded-2xl" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fafcfe 30%, #f5fafd 60%, #f0f9ff 85%, #fafcfe 100%)' }}>
              <div className="flex flex-col items-center mb-8">
                ...
                <div className="flex items-center justify-center space-x-2">
                  <div className="h-1 w-32 bg-gradient-to-r from-transparent to-histown-primary rounded-full"></div>
                  <div className="w-2 h-2 bg-histown-accent rounded-full"></div>
                  <div className="h-1 w-64 bg-gradient-to-r from-histown-primary via-histown-accent to-histown-primary rounded-full"></div>
                  <div className="w-2 h-2 bg-histown-accent rounded-full"></div>
                  <div className="h-1 w-32 bg-gradient-to-r from-histown-primary to-transparent rounded-full"></div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-12 sm:px-16 lg:px-20">
          ...
          <div className="relative px-16 animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 ease-out" style={{ transitionDelay: '400ms' }}>
            ...
            <div className="overflow-hidden py-4">
              <div id="testimonials-track-trial" className="flex transition-transform duration-300 ease-in-out">
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center justify-items-center">
            ...
            <div className="text-white blue-section-text animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 ease-out text-center w-full max-w-md">
              ...
              <p className="text-lg mb-8 text-white blue-section-text leading-relaxed">
                Ready to get started? Register for your free trial today!
              </p>
