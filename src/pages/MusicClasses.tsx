...
const MusicClasses: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] min-h-[400px] sm:min-h-[500px] flex items-center justify-center overflow-hidden section-divider-mobile">
        <div 
      ...
      {/* Music Classes Grid Section - Mobile optimized */}
      <section 
      ...
      <WhyUs 
        description="We provide music instruction in a Christ-centered environment that nurtures each student's God-given gifts for ministry, outreach, and entertainment."
        values={whyUsValues}
      />
