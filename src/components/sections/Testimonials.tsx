...
export function Testimonials({ 
  ...
  return (
    <section 
      ...
      style={{ marginTop: '-4rem', paddingTop: '6rem', marginBottom: '-4rem', paddingBottom: '6rem' }}
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-12 lg:px-20">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 mb-6 sm:mb-8 animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 ease-out" style={{ transitionDelay: '200ms' }}>
          <img 
            src="https://res.cloudinary.com/dxqzby6fc/image/upload/v1762302377/2yG3qAq_nzcotl.png" 
            alt="Williamson's Best 2025 Winner" 
            className="h-40 sm:h-48 w-auto object-contain rounded-2xl mx-auto"
          />
          <img 
